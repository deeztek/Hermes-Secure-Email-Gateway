...
echo "Whole path incl. upgrading afterwards: ${HERMES_ROOT}/docs/install/legacy-to-docker.md"
echo ""
echo "  0. Verify the migration FIRST, before the archive restore:"
echo "       sudo ${HERMES_ROOT}/scripts/verify_legacy_migration.sh"
echo "     Read-only, seconds. Answers whether the schema bridge landed what it"
echo "     claimed. Exits non-zero on failure."
echo ""
...
echo ""
echo "  7. AFTERWARDS: upgrade to the current release. This gateway is now an"
echo "     ordinary v260912 install and takes the normal upgrade path:"
echo "       sudo ${HERMES_ROOT}/scripts/system_update_docker.sh"
echo "     v260912 is the FINAL release supporting migration, so you arrive here"
echo "     and then move forward like any other install."
echo ""

...
<cfquery name="getcaname" datasource="#datasource#">
select * from ca_settings where id='#form.id#'
</cfquery>

<cfquery name="getcacerts" datasource="#datasource#">
select * from recipient_certificates where ca_id='#form.id#'
</cfquery>

<cfif #getcacerts.recordcount# GTE 1>
<cflocation url="ca_settings.cfm?m2=1##bottom">

<cfelseif #getcacerts.recordcount# LT 1>

<cfif #getcaname.ca_djigzo_id# is not "">
<cfquery name="getthumbprint" datasource="djigzo">
select cm_id, cm_thumbprint from cm_certificates where cm_id='#getcaname.ca_djigzo_id#'
</cfquery>

<cfquery name="delete2" datasource="djigzo">
delete from cm_certificates where cm_id='#getcaname.ca_djigzo_id#'
</cfquery>
...
arguments="-rf #currentDirectory#"
timeout = "60">
</cfexecute>
</cfif>
<cfquery name="deleteca" datasource="#datasource#">
delete from ca_settings where id='#form.id#'
</cfquery>

<cflocation url="ca_settings.cfm?m2=2##bottom">

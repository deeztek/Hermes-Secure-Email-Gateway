...
SELECT count(mail_id) as count, sid, spam_level, mail_id, secret_id, time_iso, subject, from_addr, content FROM msgs where #searchfor# Collate utf8_general_ci like '%#filter5#%'
</cfquery>
...
SELECT sid, spam_level, mail_id, secret_id, time_iso, subject, from_addr, content, archive FROM msgs where #searchfor# Collate utf8_general_ci like '%#filter5#%' order by time_iso desc limit #StartRow#, #DisplayRows#
</cfquery>

<cfelseif #totalevents# EQ 1>
<cfquery name="getmsgs" datasource="#datasource#">
SELECT sid, spam_level, mail_id, secret_id, time_iso, subject, from_addr, content, archive FROM msgs where #searchfor# Collate utf8_general_ci like '%#filter5#%' order by time_iso desc 
</cfquery>
...
<cfset searchfor="">
<cflocation url="message_history.cfm?m5=16">
</cfif>
...
<cffile action = "write"
    file = "/var/www/schedule/#customtrans3#_search_task.cfm"
...
starttime="#time1#"
requesttimeout="7200"
url="http://localhost:8080/schedule/#customtrans3#_search_task.cfm"
interval="once">
...
<cflocation url="message_history.cfm?m5=14">
...
SELECT msgs.sid, msgs.spam_level, msgs.mail_id,  msgs.secret_id, msgs.time_iso, msgs.subject, msgs.from_addr, msgs.content, msgs.archive, 
 ...
 body_temp.customtrans = '#session.customtrans#'  order by msgs.time_iso desc limit #StartRow#, #DisplayRows#
</cfquery>
...
SELECT msgs.sid, msgs.spam_level, msgs.mail_id,  msgs.secret_id, msgs.time_iso, msgs.subject, msgs.from_addr, msgs.content, msgs.archive, 
 body_temp.quar_loc, body_temp.customtrans from body_temp LEFT JOIN msgs ON msgs.quar_loc = body_temp.quar_loc where
 body_temp.customtrans = '#session.customtrans#'  order by msgs.time_iso desc
</cfquery>
...
<cfquery name="getevents" datasource="#datasource#">
SELECT count(msgs.mail_id) as count, msgrcpt.rid, msgrcpt.mail_id, maddr.email as toEmail, maddr.id, msgs.sid, msgs.spam_level, msgs.mail_id, msgs.secret_id, msgs.time_iso, subject, msgs.from_addr, msgs.content from msgs INNER JOIN msgrcpt ON msgs.mail_id = msgrcpt.mail_id INNER JOIN maddr ON msgrcpt.rid = maddr.id where maddr.email like '%#filter5#%'
</cfquery>
...
<cfif #totalevents# GT 1>
<cfquery name="getmsgs" datasource="#datasource#">
SELECT msgrcpt.rid, msgrcpt.mail_id, maddr.email as toEmail, maddr.id, msgs.sid, msgs.spam_level, msgs.mail_id, msgs.secret_id, msgs.time_iso, subject, msgs.from_addr, msgs.content, msgs.archive from msgs INNER JOIN msgrcpt ON msgs.mail_id = msgrcpt.mail_id INNER JOIN maddr ON msgrcpt.rid = maddr.id where maddr.email like '%#filter5#%' order by msgs.time_iso desc limit #StartRow#, #DisplayRows#
</cfquery>
...
<cfquery name="getevents" datasource="#datasource#">
SELECT count(mail_id) as count, sid, spam_level, mail_id, secret_id, time_iso, subject, from_addr, content FROM msgs where sid='#emailexists.id#'
</cfquery>
...
<cfif #totalevents# GT 1>
<cfquery name="getmsgs" datasource="#datasource#">
SELECT sid, spam_level, mail_id, secret_id, time_iso, subject, from_addr, content, archive FROM msgs where #searchfor# = '#emailexists.id#' order by time_iso desc limit #StartRow#, #DisplayRows#
</cfquery>

<cfelseif #totalevents# EQ 1>
<cfquery name="getmsgs" datasource="#datasource#">
SELECT sid, spam_level, mail_id, secret_id, time_iso, subject, from_addr, content, archive FROM msgs where #searchfor# = '#emailexists.id#' order by time_iso desc 
</cfquery>
...
<cfquery name="getevents" datasource="#datasource#">
SELECT count(mail_id) as count, sid, spam_level, mail_id, secret_id, time_iso, subject, from_addr, content FROM msgs where time_iso between '#startdate2# #starttime2#' and '#enddate2# #endtime2#'
</cfquery>
...
<cfif #totalevents# GT 1>
<cfquery name="getmsgs" datasource="#datasource#">
SELECT sid, spam_level, mail_id, secret_id, time_iso, subject, from_addr, content, archive FROM msgs where time_iso between '#startdate2# #starttime2#' and '#enddate2# #endtime2#' order by time_iso desc limit #StartRow#, #DisplayRows#
</cfquery>

<cfelseif #totalevents# EQ 1>
<cfquery name="getmsgs" datasource="#datasource#">
SELECT sid, spam_level, mail_id, secret_id, time_iso, subject, from_addr, content, archive FROM msgs where time_iso between '#startdate2# #starttime2#' and '#enddate2# #endtime2#' order by time_iso desc
</cfquery>
</cfif>
...
<cfquery name="getevents" datasource="#datasource#">
SELECT count(mail_id) as count, sid, spam_level, mail_id, secret_id, time_iso, subject, from_addr, content FROM msgs where #searchfor# Collate utf8_general_ci like '%#filter5#%' and content like binary '#sortby#'
</cfquery>
...
<cfif #totalevents# GT 1>
<cfquery name="getmsgs" datasource="#datasource#">
SELECT sid, spam_level, mail_id, secret_id, time_iso, subject, from_addr, content, archive FROM msgs where #searchfor# Collate utf8_general_ci like '%#filter5#%' and content like binary '#sortby#' order by time_iso desc limit #StartRow#, #DisplayRows#
</cfquery>
<cfelseif #totalevents# EQ 1>
<cfquery name="getmsgs" datasource="#datasource#">
SELECT sid, spam_level, mail_id, secret_id, time_iso, subject, from_addr, content, archive FROM msgs where #searchfor# Collate utf8_general_ci like '%#filter5#%' and content like binary '#sortby#' order by time_iso desc
</cfquery>
</cfif>
...
<cfquery name="getevents" datasource="#datasource#">
SELECT count(msgs.mail_id) as count, msgrcpt.rid, msgrcpt.mail_id, maddr.email as toEmail, maddr.id, msgs.sid, msgs.spam_level, msgs.mail_id, msgs.secret_id, msgs.time_iso, subject, msgs.from_addr, msgs.content from msgs INNER JOIN msgrcpt ON msgs.mail_id = msgrcpt.mail_id INNER JOIN maddr ON msgrcpt.rid = maddr.id where maddr.email like '%#filter5#%' and msgs.content like binary '#sortby#'
</cfquery>
...
<cfif #totalevents# GT 1>
<cfquery name="getmsgs" datasource="#datasource#">
SELECT msgrcpt.rid, msgrcpt.mail_id, maddr.email as toEmail, maddr.id, msgs.sid, msgs.spam_level, msgs.mail_id, msgs.secret_id, msgs.time_iso, subject, msgs.from_addr, msgs.content, msgs.archive from msgs INNER JOIN msgrcpt ON msgs.mail_id = msgrcpt.mail_id INNER JOIN maddr ON msgrcpt.rid = maddr.id where maddr.email like '%#filter5#%' and msgs.content like binary '#sortby#' order by msgs.time_iso desc limit #StartRow#, #DisplayRows#
</cfquery>
...
<cfif #totalevents# GT 1>
<cfquery name="getmsgs" datasource="#datasource#">
SELECT sid, spam_level, mail_id, secret_id, time_iso, subject, from_addr, content, archive FROM msgs where #searchfor# = '#emailexists.id#' and content like binary '#sortby# 'order by time_iso desc limit #StartRow#, #DisplayRows#
</cfquery>

<cfelseif #totalevents# EQ 1>
<cfquery name="getmsgs" datasource="#datasource#">
SELECT sid, spam_level, mail_id, secret_id, time_iso, subject, from_addr, content, archive FROM msgs where #searchfor# = '#emailexists.id#' and content like binary '#sortby# 'order by time_iso desc 
</cfquery>
...
<cfquery name="getevents" datasource="#datasource#">
SELECT count(mail_id) as count, sid, spam_level, mail_id, secret_id, time_iso, subject, from_addr, content FROM msgs where content like binary '#sortby#' and time_iso between '#startdate2# #starttime2#' and '#enddate2# #endtime2#'
</cfquery>
...
<cfif #totalevents# GT 1>
<cfquery name="getmsgs" datasource="#datasource#">
SELECT sid, spam_level, mail_id, secret_id, time_iso, subject, from_addr, content, archive FROM msgs where content like binary '#sortby#' and time_iso between '#startdate2# #starttime2#' and '#enddate2# #endtime2#' order by time_iso desc limit #StartRow#, #DisplayRows#
</cfquery>

<cfelseif #totalevents# EQ 1>
<cfquery name="getmsgs" datasource="#datasource#">
SELECT sid, spam_level, mail_id, secret_id, time_iso, subject, from_addr, content, archive FROM msgs where content like binary '#sortby#' and time_iso between '#startdate2# #starttime2#' and '#enddate2# #endtime2#' order by time_iso desc
</cfquery>
</cfif>
...
<cfif #totalevents# GT 1>
<cfquery name="getmsgs" datasource="#datasource#">
SELECT sid, spam_level, mail_id, secret_id, time_iso, subject, from_addr, content, archive FROM msgs order by time_iso desc limit #StartRow#, #DisplayRows#
</cfquery>

<cfelseif #totalevents# EQ 1>
<cfquery name="getmsgs" datasource="#datasource#">
SELECT sid, spam_level, mail_id, secret_id, time_iso, subject, from_addr, content, archive FROM msgs order by time_iso desc
</cfquery>
</cfif>
...
<cfquery name="getevents" datasource="#datasource#">
SELECT count(mail_id) as count, sid, spam_level, mail_id, secret_id, time_iso, subject, from_addr, content FROM msgs where content like binary '#sortby#'
</cfquery>
...
<cfif #totalevents# GT 1>
<cfquery name="getmsgs" datasource="#datasource#">
SELECT sid, spam_level, mail_id, secret_id, time_iso, subject, from_addr, content, archive FROM msgs where content like binary '#sortby#' order by time_iso desc limit #StartRow#, #DisplayRows#
</cfquery>

<cfelseif #totalevents# EQ 1>
<cfquery name="getmsgs" datasource="#datasource#">
SELECT sid, spam_level, mail_id, secret_id, time_iso, subject, from_addr, content, archive FROM msgs where content like binary '#sortby#' order by time_iso desc
</cfquery>
</cfif>

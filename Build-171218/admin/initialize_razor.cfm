                  ...
                  <tr align="left" valign="top">
                    <td>
                        ...
                        <tr valign="top" align="left">
                          ...
                          <td>
                            <table border="0" cellspacing="0" cellpadding="0" width="449">
                              ...
                              <tr valign="top" align="left">
                                <td height="25"></td>
                                <td width="25"><a target="_self" href="javascript:openpopup_27b5('https://www.deeztek.com/documentation/hermes-seg-documentation/hermes-seg-administrator-guide/content-checks/initialize-vipul-s-razor/')"><img id="Picture2" height="25" width="25" src="./help.png" border="0" alt="Online Help" title="Online Help"></a></td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                      ...
                      <table border="0" cellspacing="0" cellpadding="0" width="966">
                        ...
                        <tr valign="top" align="left">
                          <td height="164"></td>
                          <td width="951"><cfparam name = "m" default = "0"> 
...
<cfexecute name = "/opt/hermes/scripts/initialize_razor.sh"
timeout = "240"
arguments="-inputformat none"
outputfile ="/opt/hermes/tmp/razorresults_#customtrans3#"
variable="razor">
</cfexecute>
<cfcatch type="any">
<cffile action = "write" file = "/opt/hermes/tmp/razorresults_#customtrans3#" output = "#cfcatch.detail#" addnewline="no">
</cfcatch>
</cftry>

<cffile action="read" file="/opt/hermes/tmp/razorresults_#customtrans3#" variable="razorlog">
<cffile action = "delete" file = "/opt/hermes/tmp/razorresults_#customtrans3#">
<cfif #razorlog# contains 'Register successful'>
<cfset m=1>
<cfelseif #razorlog# contains 'Bootstrap discovery failed'>
<cfset m=2>
</cfif>

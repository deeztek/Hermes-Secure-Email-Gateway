      ...
      <tr>
        <td>
          <table border="0" cellspacing="0" cellpadding="0" width="988">
            ...
            <tr valign="top" align="left">
              <td height="1048" width="988"><cfparam name = "m" default = "0"> 
...
<cflocation url="error.cfm">
                ...
                <table border="0" cellspacing="0" cellpadding="0" width="988" id="LayoutRegion1" style="background-image: url('./middle_988.png'); height: 1048px;">
                  <tr align="left" valign="top">
                    <td>
                      <table border="0" cellspacing="0" cellpadding="0" width="965">
                        ...
                        <tr valign="top" align="left">
                          <td colspan="4" height="874"></td>
                          <td colspan="4" width="954"><cfif #action# is "view">
...
<cflocation url="spam_policies.cfm?m=7">
                            ...
                            <table border="0" cellspacing="0" cellpadding="0" width="954" id="LayoutRegion11" style="height: 874px;">
                              <tr align="left" valign="top">
                                <td>
     ...
     <tr>
      <td align="center"><input type="submit" id="FormsButton1" name="FormsButton1" value="Submit" style="height: 24px; width: 120px;" onclick="this.disabled=true;this.value='Please wait...';this.form.submit();"></input></td>
                        ...
                        <tr valign="top" align="left">
                          ...
                          <td colspan="5" valign="middle" width="953"><hr id="HRRule6" width="953" size="1"></td>
                          <td></td>
                        </tr>
                        <tr valign="top" align="left">

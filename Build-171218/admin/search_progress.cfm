...
<cffile
    action = "delete"
    file = "/opt/hermes/tmp/#form.customtrans#_grepmail.sh">

<cffile
    action = "delete"
    file = "/opt/hermes/tmp/#form.customtrans#_results.txt">

<cffile
    action = "delete"
    file = "/var/www/schedule/#form.customtrans#_search_task.cfm">
...
<cflocation url="search_progress.cfm?m1=1">
</cfif>
...
<cflocation url="search_progress.cfm?m1=2">
</cfif>

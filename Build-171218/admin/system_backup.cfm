...
<cfparam name = "archive" default = "yes"> 
<cfif IsDefined("form.archive") is "True">
<cfif form.archive is not "">
<cfset archive = form.archive>
</cfif></cfif>

<cfparam name = "encrypt" default = "no"> 
<cfif IsDefined("form.encrypt") is "True">
<cfif form.encrypt is not "">
<cfset encrypt = form.encrypt>
</cfif></cfif>
...
<cffile action="read" file="/opt/hermes/scripts/validate_share.sh" variable="validateshare">
...
<cfset testfile="/mnt/hermesbackuptest/testsmb">
...
<cfexecute name = "/opt/hermes/scripts/umount_share.sh"
timeout = "240"
outputfile ="/dev/null"
arguments="-inputformat none">
</cfexecute>
...
select * from backup_jobs where entry_name='#show_entry_name#' 
</cfquery>
...
(entry_name, server, domain, share, username, password, scheduled, scheduled_interval, directory, startdate, notification, retention, archive, encrypt)
values
('#show_entry_name#', '#show_server#', '#show_domain#', '#show_share#', '#show_username#', '#show_password#', '1', '#show_interval#', '#show_directory#', '#date2# #time2#', '#show_notification#', '#show_retention#', '#archive#', '#encrypt#')
</cfquery>
...
task="backupjob_#show_entry_name#"
operation="HTTPRequest"
startdate="#date1#"
starttime="#time1#"
requesttimeout="7200"
url="http://localhost:8080/schedule/#show_entry_name#_backup_task.cfm"
...
<cffile action = "write"
    file = "/var/www/schedule/#show_entry_name#_backup_task.cfm"
    output = "#REReplace("#backuptask#","ENTRY-NAME","#show_entry_name#","ALL")#"> 
    

<cfif #archive# is "no" and #encrypt# is "no">     
<cffile action="read" file="/opt/hermes/templates/system_backup.sh" variable="backup">
<cfelseif #archive# is "yes" and #encrypt# is "no">
<cffile action="read" file="/opt/hermes/templates/system_backup_archive.sh" variable="backup">
<cfelseif #archive# is "yes" and #encrypt# is "yes">
<cffile action="read" file="/opt/hermes/templates/system_backup_archive_encrypted.sh" variable="backup">
<cfelseif #archive# is "no" and #encrypt# is "yes">
<cffile action="read" file="/opt/hermes/templates/system_backup_encrypted.sh" variable="backup">
</cfif>


<cffile action = "write"
    file = "/opt/hermes/schedule/#show_entry_name#_system_backup.sh"
    output = "#REReplace("#backup#","SERVER","#show_server#","ALL")#"> 

<cffile action="read" file="/opt/hermes/schedule/#show_entry_name#_system_backup.sh" variable="backup">
   
<cffile action = "write"
    file = "/opt/hermes/schedule/#show_entry_name#_system_backup.sh"
    output = "#REReplace("#backup#","SHARE","#show_share#","ALL")#">  
    
<cffile action="read" file="/opt/hermes/schedule/#show_entry_name#_system_backup.sh" variable="backup">
   
<cffile action = "write"
    file = "/opt/hermes/schedule/#show_entry_name#_system_backup.sh"
    output = "#REReplace("#backup#","DIRECTORY","#show_directory#","ALL")#">  

<cffile action="read" file="/opt/hermes/schedule/#show_entry_name#_system_backup.sh" variable="backup">
   
<cffile action = "write"
    file = "/opt/hermes/schedule/#show_entry_name#_system_backup.sh"
    output = "#REReplace("#backup#","DOMAIN","#show_domain#","ALL")#">  
    
<cffile action="read" file="/opt/hermes/schedule/#show_entry_name#_system_backup.sh" variable="backup">
   
<cffile action = "write"
    file = "/opt/hermes/schedule/#show_entry_name#_system_backup.sh"
    output = "#REReplace("#backup#","USERNAME","#show_username#","ALL")#"> 
    
<cffile action="read" file="/opt/hermes/schedule/#show_entry_name#_system_backup.sh" variable="backup">
   
<cffile action = "write"
    file = "/opt/hermes/schedule/#show_entry_name#_system_backup.sh"
    output = "#REReplace("#backup#","PASSWORD","#show_password#","ALL")#"> 
...
<cffile action = "write"
    file = "/opt/hermes/schedule/#show_entry_name#_system_backup.sh"
    output = "#REReplace("#backup#","FROM","#getpostmaster.value#","ALL")#"> 
    
<cffile action="read" file="/opt/hermes/schedule/#show_entry_name#_system_backup.sh" variable="backup">
   
<cffile action = "write"
    file = "/opt/hermes/schedule/#show_entry_name#_system_backup.sh"
    output = "#REReplace("#backup#","RETENTION","#show_retention#","ALL")#"> 
    
<cffile action="read" file="/opt/hermes/schedule/#show_entry_name#_system_backup.sh" variable="backup">
       
<cffile action = "write"
    file = "/opt/hermes/schedule/#show_entry_name#_system_backup.sh"
    output = "#REReplace("#backup#","TO","#show_notification#","ALL")#"> 
    
<cffile action="read" file="/opt/hermes/schedule/#show_entry_name#_system_backup.sh" variable="backup">
       
<cffile action = "write"
    file = "/opt/hermes/schedule/#show_entry_name#_system_backup.sh"
    output = "#REReplace("#backup#","JOB-ID","#adResult.GENERATED_KEY#","ALL")#"> 
    
<cfexecute name = "/bin/chmod"
arguments="+x /opt/hermes/schedule/#show_entry_name#_system_backup.sh"
timeout = "60">
</cfexecute>
...
<cfset m=17>
                            ...
                            <table border="0" cellspacing="0" cellpadding="0" width="965" id="LayoutRegion1" style="height: 668px;">
                              <tr align="left" valign="top">
                                <td>
                                          ...
                                          <table id="Table76" border="0" cellspacing="0" cellpadding="0" width="100%" style="height: 551px;">
                                            <tr style="height: 15px;">
                                              <td width="959" id="Cell739">
                                                <p style="margin-bottom: 0px;"><b><span style="font-family: Arial,Helvetica,Geneva,Sans-serif; font-size: 12px; color: rgb(51,51,51);">Backup Job Create&nbsp; Mode</span></b></p>
                                              </td>
                                            </tr>
...
<option value="#TimeFormat(i, "HH:mm:ss")#">#TimeFormat(i, "hh:mm tt")#</option>
                                            ...
                                            <tr style="height: 15px;">
                                              <td id="Cell1062">
                                                <p style="margin-bottom: 0px;"><b><span style="font-size: 12px;">Include E-mail Archive Data in Backup Job</span></b></p>
                                              </td>
                                            </tr>
...
<cfif #m# is "19">
<cfoutput>
<p style="margin-bottom: 0px;"><b><i><span style="font-family: Arial,Helvetica,Geneva,Sans-serif; font-size: 12px; color: rgb(16,174,75);"><img id="Picture37" height="14" width="15" src="checkmark_icon.png" vspace="0" hspace="0" align="top" border="0" alt="checkmark_icon" title="checkmark_icon">&nbsp;Success!! Share Validated. Please select "Save Backup Job" selection box on top and click the "Submit" button to save the backup job</span></i></b></p>
</cfoutput>
</cfif>
...
&nbsp;</p>
                      ...
                      <table border="0" cellspacing="0" cellpadding="0" width="966">
                        ...
                        <tr valign="top" align="left">
                          ...
                          <td colspan="4" valign="middle" width="958"><hr id="HRRule1" width="958" size="1"></td>
                        </tr>
                        <tr valign="top" align="left">
                        ...
                        <tr valign="top" align="left">
                          <td height="64"></td>
                          <td colspan="4" width="958"><cfparam name = "m2" default = "0">
                                  ...
                                  <table border="0" cellspacing="0" cellpadding="0" width="958">
                                    <tr valign="top" align="left">
                                      <td width="958" id="Text367" class="TextObject">
                                        <p style="margin-bottom: 0px;"><cfquery name="getbackups" datasource="#datasource#">
...
<cfquery name="checkbackup" datasource="#datasource#">
select status from backup_jobs where status='running'
</cfquery>

<cfif #checkbackup.recordcount# GTE 1>
<cfset backupstatus="running">
<cfelseif #checkbackup.recordcount# LT 1>
<cfset backupstatus="notrunning">
</cfif>


<cfif #getbackups.recordcount# LT 1>
...
<cfelseif #getbackups.recordcount# GTE 1>
...
<cfoutput query="getbackups">
  <tr style="height: 19px;">

<cfif #backupstatus# is "notrunning">
...
<cfelseif #backupstatus# is "running">
...
<td id="Cell772">
      <p style="text-align: center; margin-bottom: 0px;"><span style="font-family: Arial,Helvetica,Geneva,Sans-serif; font-size: 12px; color: rgb(128,128,128);">#archive#</span></p>
    </td>

    <td id="Cell772">
      <p style="text-align: center; margin-bottom: 0px;"><span style="font-family: Arial,Helvetica,Geneva,Sans-serif; font-size: 12px; color: rgb(128,128,128);">#timeformat(startdate, "HH:mm:ss")#</span></p>
    </td>

<td id="Cell772">
      <p style="text-align: center; margin-bottom: 0px;"><span style="font-family: Arial,Helvetica,Geneva,Sans-serif; font-size: 12px; color: rgb(128,128,128);">#notification#</span></p>
    </td>

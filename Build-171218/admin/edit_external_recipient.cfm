...
select * from external_recipients where id = <cfqueryparam value = #url.id# CFSQLType = "CF_SQL_INTEGER">
</cfquery>

<cfif #getencryption.recordcount# LT 1>
...
<cfparam name = "show_email" default = "#getencryption.email#"> 


<cfparam name = "show_encryption_mode" default = "#getencryption.encryption_mode#"> 

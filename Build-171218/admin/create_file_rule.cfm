                      ...
                      <table border="0" cellspacing="0" cellpadding="0" width="973">
                        ...
                        <tr valign="top" align="left">
                          ...
                          <td width="506" id="Text351" class="TextObject">
                            <p style="margin-bottom: 0px;"><b><span style="font-size: 16px; color: rgb(0,51,153);">Create File Rule</span></b></p>
                          </td>
                          <td colspan="2"></td>
                        </tr>
                        <tr valign="top" align="left">
                              ...
                              <tr align="left" valign="top">
                                <td>
                                  <table border="0" cellspacing="0" cellpadding="0" width="957">
                                    <tr valign="top" align="left">
                                      <td height="223" width="957"><cfparam name = "m1" default = "0">
...
<cfparam name = "template" default = "add"> 
...
<input type="submit" name="action" value="Cancel All" style="height: 24px; width: 136px;" disabled="disabled">
                                  ...
                                  <table border="0" cellspacing="0" cellpadding="0" width="957">
                                    ...
                                    <tr valign="top" align="left">
                                      <td width="957" id="Text277" class="TextObject">

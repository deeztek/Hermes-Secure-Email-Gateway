                    ...
                    <td>
                      <table border="0" cellspacing="0" cellpadding="0" width="967">
                        ...
                        <tr valign="top" align="left">
                          ...
                          <td colspan="4" width="955"><cfparam name = "m" default = "0">
...
<cfquery name="checkauto" datasource="#datasource#">
select * from external_recipients where email='#theEMAIL#' 
</cfquery>

<cfif #checkauto.recordcount# GTE 1>
<cflocation url="error.cfm" addToken = "no">
</cfif>

<cfquery name="getrecipientdetails" datasource="djigzo">
select cm_email, cm_locality from cm_users where cm_email='#theEMAIL#' and cm_locality is NULL
</cfquery>
...
<cflocation url="external_encryption_users.cfm?action=pdfpassword&StartRow=#StartRow#&DisplayRows=#DisplayRows#&filter=#filter#&show=#show#" addToken = "no">
                            ...
                            <table border="0" cellspacing="0" cellpadding="0" width="955" id="LayoutRegion11" style="height: 230px;">
                              <tr align="left" valign="top">
                                <td>
                                  <form name="LayoutRegion11FORM" action="<cfoutput>reset_pdf_password_auto.cfm?email=#theEMAIL#&StartRow=#StartRow#&DisplayRows=#DisplayRows#&filter=#filter#&show=#show#</cfoutput>" method="post">
                                              ...
                                              <td id="Cell60">
                                                <p style="text-align: right; margin-bottom: 0px;"><span style="font-family: Arial,Helvetica,Geneva,Sans-serif; font-size: 14px; color: rgb(51,51,51);"></span>
                                                  <table width="240" border="0" cellspacing="0" cellpadding="0" align="left">
                                                    <tr>
                                                      <td><cfoutput><input type="text" id="FormsEditField4" name="recipient" size="30" maxlength="30" disabled="disabled" style="width: 236px; white-space: pre;" value="#theEMAIL#"></cfoutput></td>
                                                    </tr>
                                                  </table>
                                                </td>
                                                </cfoutput>

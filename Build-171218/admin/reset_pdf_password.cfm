                    ...
                    <td>
                      <table border="0" cellspacing="0" cellpadding="0" width="970">
                        ...
                        <tr valign="top" align="left">
                          ...
                          <td colspan="4" width="956"><cfparam name = "m" default = "0">
...
<cfset decryptedPassword=decrypt(getrecipientdetails.pdf_password, #theKey#,
 "AES", "Base64")>

<cfif #getrecipientdetails.pdf# is not "1">
<cflocation url="error.cfm" addToken = "no">
<cfelseif #getrecipientdetails.pdf# is "1">
<cfif #getrecipientdetails.pdf_mode# is not "static">
<cflocation url="error.cfm" addToken = "no">
</cfif>
</cfif>
...
<cffile action="read" file="/opt/hermes/scripts/reset_pdf_password.sh" variable="temp">

<cffile action = "write"
    file = "/opt/hermes/scripts/#customtrans3#_reset_pdf_password.sh"
    output = "#REReplace("#temp#","THE-RECIPIENT","#getrecipientdetails.email#","ALL")#" addnewline="no">

<cffile action="read" file="/opt/hermes/scripts/#customtrans3#_reset_pdf_password.sh" variable="temp">
...
arguments="+x /opt/hermes/scripts/#customtrans3#_reset_pdf_password.sh"
timeout = "60">
</cfexecute>

<cfexecute name = "/opt/hermes/scripts/#customtrans3#_reset_pdf_password.sh"
timeout = "240"
outputfile ="/dev/null"
...
<cffile action="read" file="/opt/hermes/keys/hermes.key" variable="theKey">
<cfset encryptedPassword=encrypt(show_password1, #theKey#, "AES", "Base64")>
...
where email='#getrecipientdetails.email#'
</cfquery>
...
<cfoutput>
<cflocation url="external_encryption_users.cfm?action=pdfpassword&StartRow=#StartRow#&DisplayRows=#DisplayRows#&filter=#filter#&show=#show#" addToken = "no">
</cfoutput>
</cfif>
                            ...
                            <table border="0" cellspacing="0" cellpadding="0" width="956" id="LayoutRegion11" style="height: 270px;">
                              <tr align="left" valign="top">
                                <td>
                                  <form name="LayoutRegion11FORM" action="<cfoutput>reset_pdf_password.cfm?id=#theID#&StartRow=#StartRow#&DisplayRows=#DisplayRows#&filter=#filter#&show=#show#</cfoutput>" method="post">
                                              ...
                                              <tr style="height: 22px;">
                                                ...
                                                <td id="Cell62">
                                                  <p style="text-align: right; margin-bottom: 0px;"><span style="font-family: Arial,Helvetica,Geneva,Sans-serif; font-size: 14px; color: rgb(51,51,51);"></span>
                                                    <table width="240" border="0" cellspacing="0" cellpadding="0" align="left">
                                                      <tr>
                                                        <td><cfoutput><input type="text" id="FormsEditField42" name="decryptedpassword" size="30" maxlength="30" disabled="disabled" style="width: 236px; white-space: pre;" value="#decryptedPassword#"></cfoutput></td>
                                                      </tr>
                                                    </table>
                                                  </td>
                                                  </cfoutput>

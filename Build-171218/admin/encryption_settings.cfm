...
<cfset theKeyword = #get_serverkeyword.value#>
<cfelse>
<cffile action="read" file="/opt/hermes/keys/hermes.key" variable="hermeskey">
<cfset theKeyword = decrypt(get_serverkeyword.value, #hermeskey#, "AES", "Base64")>
...
<cfparam name = "show_serverkeyword" default = "#theKeyword#"> 
...
<cfif #action# is "Generate Keyword">
...
<cfset show_serverkeyword=#gettrans.customtrans2#>
...
<cfset m=8>
<cfelse>
<cfif REFind("[a-z]",show_serverkeyword) gte 1 and REFind("[A-Z]",show_serverkeyword) gte 1 and REFind("[0-9]",show_serverkeyword) GTE 1>
<cfset step=4>
<cfelse>
<cfset step=0>
<cfset m=8>
...
<cffile action = "write"
    file = "/opt/hermes/scripts/#customtrans3#_edit_encryption_settings.sh"
    output = "#REReplace("#temp#","PDFREPLY-SENDER","#show_pdfreply_sender#","ALL")#" addnewline="no">

<cffile action="read" file="/opt/hermes/scripts/#customtrans3#_edit_encryption_settings.sh" variable="temp">
...
arguments="+x /opt/hermes/scripts/#customtrans3#_edit_encryption_settings.sh"
timeout = "60">
</cfexecute>

<cfexecute name = "/opt/hermes/scripts/#customtrans3#_edit_encryption_settings.sh"
timeout = "240"
outputfile ="/dev/null"
...
<input type="text" name="pdfreply_sender" size="30" maxlength="255" style="width: 396px; white-space: pre;" value="#show_pdfreply_sender#" >
                                            ...
                                            <tr style="height: 14px;">
                                              <td id="Cell1032">
                                                <p style="margin-bottom: 0px;"><b><span style="font-family: Arial,Helvetica,Geneva,Sans-serif; font-size: 12px; color: rgb(51,51,51);">Auto-Generate Server Secret Keyword</span></b></p>
                                              </td>
                                            </tr>
                                                        ...
                                                        <tr style="height: 21px;">
                                                          <td width="55" id="Cell1036">
                                                            <table width="31" border="0" cellspacing="0" cellpadding="0" align="left">
                                                              <tr>
                                                                <td class="TextObject">
                                                                  <p style="margin-bottom: 0px;"><button type="submit" name="action" value="Generate Keyword"><img src="generate_icon.png" alt="Generate Keyword"></button&nbsp;</p>
                                                                </td>
                                                              </tr>
                                                            </table>
                                                            &nbsp;</td>
...
&nbsp;</p>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0" width="964">
                                      <tr valign="top" align="left">
                                        <td width="964" height="4"></td>
                                      </tr>
                                      <tr valign="top" align="left">
                                        <td width="964" id="Text185" class="TextObject">
                                          <p style="text-align: left; margin-bottom: 0px;"><cfif #m# is "1">
<cfoutput>
<p style="margin-bottom: 0px;"><b><i><span style="font-family: Arial,Helvetica,Geneva,Sans-serif; font-size: 12px; color: rgb(255,0,0);"><img id="Picture37" height="14" width="15" src="warning_icon1.png" vspace="0" hspace="0" align="top" border="0" alt="warning_icon1" title="warning_icon1">&nbsp;the Secure Portal Address cannot be blank</span></i></b></p>
</cfoutput>
</cfif>

<cfif #m# is "2">
<cfoutput>
<p style="margin-bottom: 0px;"><b><i><span style="font-family: Arial,Helvetica,Geneva,Sans-serif; font-size: 12px; color: rgb(255,0,0);"><img id="Picture37" height="14" width="15" src="warning_icon1.png" vspace="0" hspace="0" align="top" border="0" alt="warning_icon1" title="warning_icon1">&nbsp;the PDF Reply Sender E-mail must be a valid e-mail address</span></i></b></p>
</cfoutput>
</cfif>

<cfif #m# is "3">
<cfoutput>
<p style="margin-bottom: 0px;"><b><i><span style="font-family: Arial,Helvetica,Geneva,Sans-serif; font-size: 12px; color: rgb(255,0,0);"><img id="Picture37" height="14" width="15" src="warning_icon1.png" vspace="0" hspace="0" align="top" border="0" alt="warning_icon1" title="warning_icon1">&nbsp;the PDF Reply Sender E-mail must not be blank</span></i></b></p>
</cfoutput>
</cfif>

<cfif #m# is "4">
<cfoutput>
<p style="margin-bottom: 0px;"><b><i><span style="font-family: Arial,Helvetica,Geneva,Sans-serif; font-size: 12px; color: rgb(255,0,0);"><img id="Picture37" height="14" width="15" src="warning_icon1.png" vspace="0" hspace="0" align="top" border="0" alt="warning_icon1" title="warning_icon1">&nbsp;the Encryption by e-mail subject keyword field cannot be blank</span></i></b></p>
</cfoutput>
</cfif>
...
<cfif #m# is "8">
<cfoutput>
<p style="margin-bottom: 0px;"><b><i><span style="font-family: Arial,Helvetica,Geneva,Sans-serif; font-size: 12px; color: rgb(255,0,0);"><img id="Picture37" height="14" width="15" src="warning_icon1.png" vspace="0" hspace="0" align="top" border="0" alt="warning_icon1" title="warning_icon1">&nbsp;The Server Secret Keyword must be at least 10 characters and it must contain upper/lower case letters and numbers</span></i></b></p>
</cfoutput>
</cfif>

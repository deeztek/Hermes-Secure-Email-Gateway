...
<cffile action = "write"
    ...
    output = "#REReplace("#temp#","THE-EMAIL","#theEMAIL#","ALL")#" addnewline="no">
...
<cflocation url="external_encryption_users.cfm?action=portalpassword&StartRow=#StartRow#&DisplayRows=#DisplayRows#&filter=#filter#&show=#show#" addToken = "no">
                            ...
                            <table border="0" cellspacing="0" cellpadding="0" width="957" id="LayoutRegion11" style="height: 236px;">
                              <tr align="left" valign="top">
                                <td>
                                  <form name="LayoutRegion11FORM" action="<cfoutput>reset_portal_password_auto.cfm?email=#theEMAIL#&StartRow=#StartRow#&DisplayRows=#DisplayRows#&filter=#filter#&show=#show#</cfoutput>" method="post">

...
select * from archive_jobs where id='#form.id#'
</cfquery>
...
<cfset testfile="/var/www/schedule/#getscheduled.entry_name#_archive_task.cfm">
...
<cflocation url="email_archive.cfm?m2=1" addtoken="no">

...
<cfquery name="gettotalevents" datasource="#datasource#">
...
ON msgs.mail_id = msgrcpt.mail_id where msgrcpt.rid='#session.owner#' and msgs.#searchfor# Collate utf8_general_ci like '%#filter5#%'
</cfquery>
...
ON msgs.mail_id = msgrcpt.mail_id where msgrcpt.rid='#session.owner#' and msgs.#searchfor# Collate utf8_general_ci like '%#filter5#%' group by msgrcpt.mail_id order by msgs.time_iso desc limit #StartRow#, #DisplayRows#
</cfquery>

<cfelseif #totalevents# EQ 1>
<cfquery name="getmsgs" datasource="#datasource#">
SELECT msgs.sid, msgs.spam_level, msgs.mail_id, msgs.secret_id, msgs.time_iso, msgs.subject, msgs.from_addr, msgs.content, msgs.archive,  msgrcpt.mail_id, msgrcpt.rid, msgrcpt.ds from msgrcpt RIGHT JOIN msgs 
ON msgs.mail_id = msgrcpt.mail_id where msgrcpt.rid='#session.owner#' and msgs.#searchfor# Collate utf8_general_ci like '%#filter5#%' group by msgrcpt.mail_id order by msgs.time_iso desc
</cfquery>
</cfif>

<cfelseif #searchfor# is "body">

<cffile action="read" file="/opt/hermes/scripts/grepmail_user.sh" variable="temp">

<cffile action = "write"
    file = "/opt/hermes/scripts/#customtrans3#_grepmail_user.sh"
    output = "#REReplace("#temp#","SEARCH-STRING","#filter5#","ALL")#" addnewline="no">

<cffile action="read" file="/opt/hermes/scripts/#customtrans3#_grepmail_user.sh" variable="temp">
...
<cffile action = "write"
    file = "/opt/hermes/scripts/#customtrans3#_grepmail_user.sh"
    output = "#REReplace("#temp#","RECIPIENT","#session.email#","ALL")#" addnewline="no">

<cfexecute name = "/bin/chmod"
arguments="+x /opt/hermes/scripts/#customtrans3#_grepmail_user.sh"
timeout = "60">
</cfexecute>

<cfexecute name = "/opt/hermes/scripts/#customtrans3#_grepmail_user.sh"
timeout = "240"
outputfile ="/dev/null"
arguments="-inputformat none">
</cfexecute>

<CFFILE ACTION="READ" file="/opt/hermes/tmp/#customtrans3#_results.txt" variable="results">
<cfset myfilelist = results>
<cfset linecount = listlen(results,chr(10))>

<cfloop index="curLine" list="#results#" delimiters="#chr(10)#">
<cfquery name="insert" datasource="#datasource#">
insert into body_temp
(quar_loc, customtrans)
values
('#curLine#', '#customtrans3#')
</cfquery>
</cfloop>

<cfset totalevents=#linecount#>
...
<cffile
    action = "delete"
    file = "/opt/hermes/tmp/#customtrans3#_results.txt">


<cfif #totalevents# GT 1>
<cfquery name="getmsgs" datasource="#datasource#">
SELECT msgs.sid, msgs.spam_level, msgs.mail_id,  msgs.secret_id, msgs.time_iso, msgs.subject, msgs.from_addr, msgs.content, msgs.archive, body_temp.quar_loc, body_temp.customtrans from body_temp RIGHT JOIN msgs ON msgs.quar_loc = body_temp.quar_loc where body_temp.customtrans = '#customtrans3#'  order by msgs.time_iso desc limit #StartRow#, #DisplayRows#
</cfquery>

<cfquery name="deletebodytemp" datasource="#datasource#">
delete from body_temp where customtrans = '#customtrans3#'
</cfquery>
...
<cfquery name="gettotalevents" datasource="#datasource#">
SELECT count(msgs.mail_id) as totalevents, msgs.sid, msgs.spam_level, msgs.mail_id,  msgs.secret_id, msgs.time_iso, msgs.subject, msgs.from_addr, msgs.content, msgrcpt.mail_id, msgrcpt.rid, msgrcpt.ds from msgrcpt RIGHT JOIN msgs 
ON msgs.mail_id = msgrcpt.mail_id where msgrcpt.rid='#session.owner#' and msgs.time_iso between '#startdate2# #starttime2#' and '#enddate2# #endtime2#'
</cfquery>
...
<cfquery name="gettotalevents" datasource="#datasource#">
SELECT count(msgs.mail_id) as totalevents, msgs.sid, msgs.spam_level, msgs.mail_id,  msgs.secret_id, msgs.time_iso, msgs.subject, msgs.from_addr, msgs.content, msgrcpt.mail_id, msgrcpt.rid, msgrcpt.ds from msgrcpt RIGHT JOIN msgs 
ON msgs.mail_id = msgrcpt.mail_id where msgrcpt.rid='#session.owner#' and msgs.#searchfor# Collate utf8_general_ci like '%#filter5#%' and msgs.content like binary '#sortby#' 
</cfquery>
...
<cfquery name="getmsgs" datasource="#datasource#">
SELECT msgs.sid, msgs.spam_level, msgs.mail_id,  msgs.secret_id, msgs.time_iso, msgs.subject, msgs.from_addr, msgs.content, msgs.archive,  msgrcpt.mail_id, msgrcpt.rid, msgrcpt.ds from msgrcpt RIGHT JOIN msgs 
ON msgs.mail_id = msgrcpt.mail_id where msgrcpt.rid='#session.owner#' and msgs.#searchfor# Collate utf8_general_ci like '%#filter5#%' and msgs.content like binary '#sortby#' group by msgrcpt.mail_id order by msgs.time_iso desc limit #StartRow#, #DisplayRows#
</cfquery>
...
<cfquery name="gettotalevents" datasource="#datasource#">
SELECT count(msgs.mail_id) as totalevents, msgs.sid, msgs.spam_level, msgs.mail_id,  msgs.secret_id, msgs.time_iso, msgs.subject, msgs.from_addr, msgs.content, msgrcpt.mail_id, msgrcpt.rid, msgrcpt.ds from msgrcpt RIGHT JOIN msgs 
ON msgs.mail_id = msgrcpt.mail_id where msgrcpt.rid='#session.owner#' and msgs.content like binary '#sortby#' and msgs.time_iso between '#startdate2# #starttime2#' and '#enddate2# #endtime2#'
</cfquery>
...
<cfquery name="gettotalevents" datasource="#datasource#">
SELECT count(msgs.mail_id) as totalevents, msgs.sid, msgs.spam_level, msgs.mail_id,  msgs.secret_id, msgs.time_iso, msgs.subject, msgs.from_addr, msgs.content, msgrcpt.mail_id, msgrcpt.rid, msgrcpt.ds from msgrcpt RIGHT JOIN msgs 
ON msgs.mail_id = msgrcpt.mail_id where msgrcpt.rid='#session.owner#'
</cfquery>
...
<cfquery name="getmsgs" datasource="#datasource#">
SELECT msgs.sid, msgs.spam_level, msgs.mail_id,  msgs.secret_id, msgs.time_iso, msgs.subject, msgs.from_addr, msgs.content, msgs.archive,  msgrcpt.mail_id, msgrcpt.rid, msgrcpt.ds from msgrcpt RIGHT JOIN msgs 
ON msgs.mail_id = msgrcpt.mail_id where msgrcpt.rid='#session.owner#' group by msgrcpt.mail_id order by msgs.time_iso desc limit #StartRow#, #DisplayRows#
</cfquery>
...
<td align="center"><a href="loading2.cfm?StartRow=#StartRow#&DisplayRows=#DisplayRows#&startdate=#startdate#&enddate=#enddate#&starttime=#starttime#&endtime=#endtime#&action=#action#&mid=#URLEncodedFormat(Trim(mail_id))#" onclick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=1010,height=850');return false;"><img id="Picture52" height="19" width="17" src="view_icon.png" border="0" alt="View Message" title="View Message"></td>

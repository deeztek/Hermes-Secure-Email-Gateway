      ...
      <tr>
        <td>
          <table border="0" cellspacing="0" cellpadding="0" width="988">
            ...
            <tr valign="top" align="left">
              <td height="1182" width="988"><cfparam name = "m" default = "0"> 
...
select default_policy from spam_policies where policy_id='#url.id#'
</cfquery>
...
<cfparam name = "show_policy_name" default = ""> 
...
<cfif #action# is "view">
<cfparam name = "default_policy" default = "#getdefaultpolicy.default_policy#">
<cfelseif #action# is "edit">
<cfif IsDefined("form.default_policy") is "True">
<cfset default_policy = form.default_policy>
</cfif>
</cfif>
...
select policy_name from policy where policy_name = '#form.policy_name#'
</cfquery>
...
<cfif step is "10">
<cfquery name="insertpolicy" datasource="#datasource#" result="stResultPolicy">
insert into policy
(policy_name, 
virus_lover, 
spam_lover,
...
'#form.virus_lover#',
'#form.spam_lover#',
'#form.banned_files_lover#',
'#form.bad_header_lover#',
'#form.bypass_virus_checks#',
'#form.bypass_spam_checks#',
'#form.bypass_banned_checks#',
'#form.bypass_header_checks#',
'-999',
'#form.spam_tag2_level#',
'#form.spam_kill_level#',
'Y',
'#form.banned_rulenames#',
'#form.notify_banned#',
'#form.notify_virus#',
'#form.notify_header#'
)
...
<cfquery name="getpolicyid" datasource="#datasource#">
select id from policy where id='#stResultPolicy.GENERATED_KEY#'
</cfquery>

<cfquery name="insertpolicy2" datasource="#datasource#">
...
<cfif #form.default_policy# is "1">

<cfquery name="updatedefaultall" datasource="#datasource#">
update spam_policies set
default_policy='2'
</cfquery>

<cfquery name="updatedefault" datasource="#datasource#">
update spam_policies set
default_policy='1'
where policy_id='#getpolicyid.id#'
</cfquery>

</cfif>

<cflocation url="spam_policies.cfm?m=7">

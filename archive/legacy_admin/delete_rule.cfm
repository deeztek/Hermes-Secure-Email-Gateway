...
<body style="background-color: rgb(255,255,255); background-image: none; margin: 0px;">
  <table border="0" cellspacing="0" cellpadding="0" width="803">
    ...
    <tr valign="top" align="left">
      <td></td>
      <td width="786" id="Text500" class="TextObject"><cffile action="read" file="/opt/hermes/keys/hermes.key" variable="authkey">
...
<cflocation url="file_rules.cfm?m=6" addtoken="no">
</cfif>
...
<cflocation url="file_rules.cfm?m=9" addtoken="no">
</cfif>
...
<cflocation url="file_rules.cfm?m=11" addtoken="no">
</cfif>
...
<cflocation url="file_rules.cfm?m=12" addtoken="no">

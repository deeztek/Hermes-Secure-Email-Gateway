                  ...
                  <tr align="left" valign="top">
                    <td>
                      ...
                      <table border="0" cellspacing="0" cellpadding="0" width="973">
                        ...
                        <tr valign="top" align="left">
                          <td></td>
                          <td width="964" id="Text498" class="TextObject" style="background-color: rgb(102,153,51); border: 1px solid rgb(255,0,0);">
                            <p style="margin-bottom: 0px;"><b><span style="color: rgb(255,255,255);">This page has been upgraded to our new 2.0 interface. Please click <a href="/admin/2/view_console_firewall.cfm">here</a> to use the new version</span></b></p>
                          </td>
                        </tr>
                      </table>
                    </td>

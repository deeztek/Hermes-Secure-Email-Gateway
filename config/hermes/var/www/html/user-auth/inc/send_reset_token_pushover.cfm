...
<!--- GET PUSHOVER API TOKEN FROM SYSTEM SETTINGS --->
<cfquery name="getPushoverToken" datasource="hermes">
    SELECT value FROM system_settings WHERE parameter = 'pushover_api_token'
</cfquery>

<cfif getPushoverToken.recordcount EQ 0 OR getPushoverToken.value EQ "">
...
<cfelse>
    ...
    <cfhttp url="https://api.pushover.net/1/messages.json" method="POST" result="pushoverResult">
        <cfhttpparam type="formfield" name="token" value="#getPushoverToken.value#">

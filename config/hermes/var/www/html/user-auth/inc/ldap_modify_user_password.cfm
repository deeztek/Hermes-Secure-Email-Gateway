...
- ldapOU: The LDAP organizational unit (mailboxes, relay, or users)
- newPassword: The plaintext password to set

Returns:
- ldapPasswordModified: Boolean indicating success/failure
--->

<!--- INITIALIZE RESULT VARIABLE --->
<cfset ldapPasswordModified = false>
...
<cfif NOT ldapPasswordGenerated>
...
<cfelse>
    ...
    <cfif ldapModifyResult CONTAINS "modifying entry" OR ldapModifyError CONTAINS "modifying entry">
        <cfset ldapPasswordModified = true>
    <cfelse>
        <cfset ldapPasswordModified = false>
    </cfif>

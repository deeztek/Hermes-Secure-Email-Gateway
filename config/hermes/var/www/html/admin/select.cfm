                  ...
                  <tr align="left" valign="top">
                    <td>
                      ...
                      <table border="0" cellspacing="0" cellpadding="0" width="972">
                        ...
                        <tr valign="top" align="left">
                          <td height="245"></td>
                          <td colspan="2" rowspan="2" width="958"><cfparam name = "m1" default = "0">
...
<cfparam name = "show_ip_address" default = ""> 
<cfif IsDefined("form.ip_address") is "True">
<cfif form.ip_address is not "">
<cfset show_ip_address = form.ip_address>
</cfif></cfif> 

<cfparam name = "show_network_address" default = ""> 
<cfif IsDefined("form.network_address") is "True">
<cfif form.network_address is not "">
<cfset show_network_address = form.network_address>
</cfif></cfif> 
...
<cfif #show_ip_address# is not "">
<cfif REFind(pattern,show_ip_address) GT 0>
<cfset step=1>
<cfelse>
<cfset step=0>
<cfset m2=3>
...
<cfelseif #show_ip_address# is "">
<cfset step=0>
<cfset m2=5>

<!--- /CFIF #show_ip_address# is --->
</cfif>
...
<cfif step is "2">
<cfset theAddress="#show_ip_address#">
                                                    ...
                                                    <td id="Cell1055">
                                                      <table width="220" border="0" cellspacing="0" cellpadding="0" align="left">
                                                        <tr>
                                                          <td class="TextObject">
                                                            <p style="margin-bottom: 0px;"><cfif #show_type# is "ip">
<input type="text" name="ip_address" size="30" maxlength="45" value="#show_ip_address#">
<cfelseif #show_type# is "network">
<input type="text" name="ip_address" size="30" maxlength="45" value="#show_ip_address#" disabled="disabled">
</cfif>&nbsp;</p>
                                                          </td>
                                                        </tr>
                                                      </table>
...
<cfif #show_network_address# is not "">
<cfif REFind(pattern,show_network_address) GT 0>
<cfset step=1>
<cfelse>
<cfset step=0>
<cfset m3=3>
...
<cfelseif #show_network_address# is "">
<cfset step=0>
<cfset m3=5>

<!--- /CFIF #show_network_address# is --->
</cfif>
...
<cfif step is "2">
<cfset theAddress="#show_network_address#">
                                                    ...
                                                    <td id="Cell550">
                                                      <table width="220" border="0" cellspacing="0" cellpadding="0" align="left">
                                                        <tr>
                                                          <td class="TextObject">
                                                            <p style="margin-bottom: 0px;"><cfif #show_type# is "network">
<input type="text" name="network_address" size="30" maxlength="45" value="#show_network_address#">
<cfelseif #show_type# is "ip">
<input type="text" name="network_address" size="30" maxlength="45" value="#show_network_address#" disabled="disabled">
</cfif>a</p>
                                                          </td>
                                                        </tr>
                                                      </table>
...
select * from parameters where parent='#get_mynetworks_id.id#' and child = '1' and enabled='1' and applied='1' and parameter <> '127.0.0.1' and parameter <> '172.16.32.0/24' order by order1 asc
</cfquery>

...
<cfif #getcarecepients.recordcount# LT 1>
            <td align="center"><input type="image" id="FormsButton2" name="FormsButton1" src="delete_icon.png" style="height: 19px; border-start-width: 0px; border-start-style: solid; border-top-width: 0px; border-top-style: solid; border-end-width: 0px; border-end-style: solid; border-bottom-width: 0px; border-bottom-style: solid; width: 19px;"></td>
<cfelseif #getcarecepients.recordcount# GTE 1>
<td align="center"><input type="image" id="FormsButton2" name="FormsButton1" disabled="disabled" src="delete_icon_off.png" style="height: 19px; border-start-width: 0px; border-start-style: solid; border-top-width: 0px; border-top-style: solid; border-end-width: 0px; border-end-style: solid; border-bottom-width: 0px; border-bottom-style: solid; width: 19px;"></td>
</cfif>
          </tr>
        </table>
      </form>

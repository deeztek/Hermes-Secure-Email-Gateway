...
<cfoutput>
  <a href="##addwhitelist_modal"  class="btn btn-primary" role="button" data-bs-toggle="modal" ><i class="fa fa-plus-square fa-lg"></i>&nbsp;&nbsp;Add SPF Whitelist Entries</a>
  </cfoutput>
...
<cfoutput query="getspfbypass">
  ...
  <td>
    ...
    <button a href="##editentry_modal"  type="button" id="delete" class="btn btn-secondary" data-bs-toggle="modal" data-id="#id#" data-entry="#entry#" data-note="#entry_note#" data-action="Edit Entry" data-type="#entry_type#"><i class="fas fa-edit"></i></button>

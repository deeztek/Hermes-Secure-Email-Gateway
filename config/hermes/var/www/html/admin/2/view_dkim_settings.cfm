...
<cfoutput>
  <a href="##adddomain_modal"  class="btn btn-primary" role="button" data-bs-toggle="modal" ><i class="fa fa-plus-square fa-lg"></i>&nbsp;&nbsp;Add Whitelisted Domain(s)</a>
  </cfoutput>
...
<cfoutput>
  <a href="##addhost_modal"  class="btn btn-primary" role="button" data-bs-toggle="modal" ><i class="fa fa-plus-square fa-lg"></i>&nbsp;&nbsp;Add Trusted Host(s)</a>
  </cfoutput>
...
<cfoutput query="getdkimtrusted">
  ...
  <td>
    ...
    <button a href="##editentry_modal"  type="button" id="delete" class="btn btn-secondary" data-bs-toggle="modal" data-id="#id#" data-entry="#host#" data-note="#note#" data-action="Edit Host"><i class="fas fa-edit"></i></button>
...
<cfoutput query="getdkimbypass">
  ...
  <td>
    ...
    <button a href="##editentry_modal"  type="button" id="delete" class="btn btn-secondary" data-bs-toggle="modal" data-id="#id#" data-entry="#entry#" data-note="#note#" data-action="Edit Domain"><i class="fas fa-edit"></i></button>

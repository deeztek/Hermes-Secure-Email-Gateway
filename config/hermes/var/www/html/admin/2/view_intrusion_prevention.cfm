...
$(document).ready(function() {
    // Troubleshooting Commands collapsible (chevron down/up)
    $('#toggleIpsTroubleshoot').on('click', function() { $('#ipsTroubleshoot').collapse('toggle'); });
    $('#ipsTroubleshoot').on('shown.bs.collapse', function() {
        $('#toggleIpsTroubleshoot').find('i').removeClass('fa-chevron-down').addClass('fa-chevron-up');
        $('#toggleIpsTroubleshoot').attr('title', 'Collapse');
    });
    $('#ipsTroubleshoot').on('hidden.bs.collapse', function() {
        $('#toggleIpsTroubleshoot').find('i').removeClass('fa-chevron-up').addClass('fa-chevron-down');
        $('#toggleIpsTroubleshoot').attr('title', 'Expand');
    });
...
<div class="card card-outline card-secondary mb-4">
    <div class="card-header">
        <h3 class="card-title">
            <button type="button" class="btn btn-sm btn-outline-secondary me-2" id="toggleIpsTroubleshoot" title="Expand">
                <i class="fas fa-chevron-down"></i>
            </button>
            <i class="fas fa-terminal"></i> Troubleshooting Commands
        </h3>
    </div>
    <div class="collapse" id="ipsTroubleshoot">
        <div class="card-body">

...
<cfoutput>
  ...
  <a href="##delete_devices_modal"  class="btn btn-danger" role="button" data-bs-toggle="modal" data-user="#getfeed.name#"><i class="fa fa-mobile"></i>&nbsp;&nbsp;Delete 2FA Devices</a>
  </cfoutput>
<!--- DELETE USER 2FA DEVICES BUTTON STARTS HERE --->
      ...
      <cfoutput>
        ...
        <tr>
          ...
          <td>
            ...
            <button a href="##edititem_modal"  type="button" id="delete" class="btn btn-secondary" data-bs-toggle="modal" data-id="#id#" data-name="#name#" data-value="#value#" data-type="#type#" data-fp="#fp#"><i class="fas fa-edit"></i></button>

...
<form>
  ...
  <cfoutput query="getdomainkeys">
    ...
    <td>
      ...
      <button a href="##deletekey_modal"  type="button" id="delete" class="btn btn-danger" data-bs-toggle="modal" data-keyid="#id#"><i class="fa fa-trash"></i></button>
    ...
    <td>
      ...
      <button a href="##viewPublickey_modal"  type="button" id="view" class="btn btn-secondary" data-bs-toggle="modal" data-key='#publicKey#'><i class="fas fa-search"></i></button>
    ...
    <td>
      ...
      <button a href="##viewPrivatekey_modal"  type="button" id="view" class="btn btn-secondary" data-bs-toggle="modal" data-key='#dkimprivatefile#'><i class="fas fa-search"></i></button>

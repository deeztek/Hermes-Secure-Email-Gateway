...
<cfoutput query="getdmarcdomains">
  ...
  <td>
    ...
    <button a href="##editdomain_modal"  type="button" id="delete" class="btn btn-secondary" data-bs-toggle="modal" data-id="#id#" data-domain="#domain#" data-note="#note#"><i class="fas fa-edit"></i></button>

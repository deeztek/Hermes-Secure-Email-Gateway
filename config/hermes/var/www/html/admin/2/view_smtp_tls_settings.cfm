...
<cfif #m# is "36">
  <div class="alert alert-success alert-dismissible">
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-hidden="true">&times;</button>
    <h4><i class="icon fa fa-check"></i> Success!</h4>
    <cfoutput>The SMTP TLS Settings was Disabled successfully.</cfoutput><br><br>
...
<cfif #m# is "38">
  <div class="alert alert-success alert-dismissible">
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-hidden="true">&times;</button>
    <h4><i class="icon fa fa-check"></i> Success!</h4>
    <cfoutput>SMTP TLS Settings Settings applied successfully.</cfoutput>
  </div>
   ...
   <div class="form-group">
            ...
            <select class="form-control" name="tlsmode" style="width: 100%;" id="tlsmode">
              ...
              <cfelse>
                ...
                <cfset step=0>
                <cfset m="SMTP TLS Settings: tls_mode is not empty, may or encrypt">
                <cfinclude template="./inc/error.cfm">
                <cfabort>

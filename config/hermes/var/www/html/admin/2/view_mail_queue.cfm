...
<div class="app-wrapper">
  ...
  <main class="app-main">
    ...
    <cfparam name = "mailqueuelimit" default = "0">
...
<a href="view_mail_queue.cfm" class="btn btn-primary" role="button" onclick="this.disabled=true;this.value='Please wait...';this.form.submit();"><i class="fas fa-sync"></i>&nbsp;&nbsp;Reload Mail Queue</a>
&nbsp;&nbsp;

    <cfoutput>
      <a href="##flushqueue_modal"  class="btn btn-primary" role="button" data-bs-toggle="modal"><i class="fas fa-toilet"></i>&nbsp;&nbsp;Flush Mail Queue</a>
    </cfoutput>
...
<cfif #mailqueuelimit# EQ 1>

<div class="alert alert-warning">
<p><i class="icon fas fa-exclamation-triangle"></i>The Mail Queue has more than 100 messages. In order conserve system resources, the output has been limited to display only 100 messages.</p>
</div>
...
<cfoutput query="getqueue">
  ...
  <td><input type="checkbox" name="msg_id" value="#QueueID#"></td>

  <td><a href="view_mail_queue_message.cfm?msg_id=#QueueID#" class="btn btn-secondary" role="button"><i class="fas fa-search"></i></a></td>

  <td>#QueueID#</td>

<td>#htmlEditFormat(Sender)#</td>

<td>#htmlEditFormat(Recipient)#</td>

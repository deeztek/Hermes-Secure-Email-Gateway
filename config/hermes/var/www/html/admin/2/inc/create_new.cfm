...
<!--- /CFIF getmaxid.maxid is "" --->
    ...
    <cfquery name="insertsystemuser" datasource="hermes" result="stResult">
      ...
      (username, email, first_name, last_name, system, applied, access_control, auth_type)
      values
      ('user_#nextid#', 'someone_#nextid#@domain.tld', 'System', 'User_#nextid#', '2', '2', 'one_factor', 'local')
      </cfquery>  

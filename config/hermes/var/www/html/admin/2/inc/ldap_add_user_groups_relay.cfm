...
1. cn=relays,ou=groups,dc=hermes,dc=local (relay users for /users access)
...
<!--- READ THE LDAP ADDUSERGROUP RELAY TEMPLATE --->
<cffile action="read" file="/opt/hermes/templates/ldap_addusergroup_relay.ldif" variable="ldapGroupTemplate">
...
<cffile action="write"
    file="/opt/hermes/tmp/#customtrans3#_addusergroup_relay.ldif"
    output="#ldapGroupLdif#"
    addNewLine="no">

<!--- EXECUTE LDAPMODIFY IN THE LDAP CONTAINER --->
<cfexecute name="/usr/local/bin/docker"
    arguments="exec hermes_ldap ldapmodify -Y EXTERNAL -H ldapi://%2Fvar%2Frun%2Fslapd%2Fldapi -f /opt/hermes/tmp/#customtrans3#_addusergroup_relay.ldif"
...
<cfset fileToDelete = "/opt/hermes/tmp/#customtrans3#_addusergroup_relay.ldif">

...
<cfparam name = "session.success_domain" default = "">
  ...
  <cfloop index="d" list="#form.domain#" delimiters="#chr(10)#">
    ...
    <cfelse>
      ...
      <!--- CHECK IF VALID DOMAIN (reject IP addresses - whitelist only accepts domain names) --->
    ...
    <cfset session.success_domain="#session.success_domain# #domain#<br>">
        ...
        <cfset session.invalid_domain="#session.invalid_domain# #domain# (Whitelisted Domain entries must be domain names, not IP addresses)<br>">

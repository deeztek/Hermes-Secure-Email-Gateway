...
--->
    ...
    update parameters set parameter='#ServerDomain#' where parent_name = 'myorigin' and child='1' and
    ...
    update parameters set parameter='#ServerName#' where parent_name = 'myhostname' and child='1' and
     module='postfix' and conf_file='main.cf'
    </cfquery>
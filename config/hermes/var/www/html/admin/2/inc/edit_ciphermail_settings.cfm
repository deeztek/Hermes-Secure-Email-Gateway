...
<cfinclude template="generate_customtrans.cfm">
    ...
    <cftry>
      ...
      arguments="exec hermes_commandbox /bin/chmod +x /opt/hermes/tmp/#customtrans3#_edit_encryption_settings.sh"
      timeout = "60">
      </cfexecute>
        
        <cfcatch type="any">
  
        <cfset m="Edit Ciphermail Settings: There was an error setting /opt/hermes/tmp/#customtrans3#_edit_encryption_settings.sh executable">

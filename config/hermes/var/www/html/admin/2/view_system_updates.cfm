...
<div class="alert alert-warning" role="alert">
  System Update is done in the CLI. More information can be found on our <a href="#" onClick="window.open('https://docs.deeztek.com/books/administrator-guide/page/system-update', '_blank')"><b>System Update</b></a> documentation.

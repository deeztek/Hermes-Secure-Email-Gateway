...
<cfoutput>
<a href="##create_modal"  class="btn btn-primary" role="button" data-bs-toggle="modal" data-recipient="#theRecipient#" data-recipientemail="#getrecipientdetails.recipient#"><i class="fa fa-plus-square fa-lg"></i>&nbsp;&nbsp;Create Keyring</a>
</cfoutput>
...
<!--- CREATE KEYRING BUTTON ENDS HERE --->
    ...
    <cfoutput>
    <a href="##import_modal"  class="btn btn-primary" role="button" data-bs-toggle="modal" data-recipient="#theRecipient#" data-recipientemail="#getrecipientdetails.recipient#"><i class="fa fa-upload fa-lg"></i>&nbsp;&nbsp;Import Keyring</a>
  </cfoutput>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form name="create_keyring" method="post" action="" data-bs-toggle="validator">
        ...
        <cfquery name="getprivatekeyalias" datasource="djigzo">
          ...
          <tr>
            ...
            <td>
              ...
              <button a href="##viewpassword_modal"  type="button" id="send" class="btn btn-secondary" data-bs-toggle="modal" data-keyring="#id#" data-password="#decryptedPassword#"><i class="fas fa-search"></i></button>
            ...
            <cfif #getkeyservers.recordcount# GTE 1>
              ...
              <td>
                ...
                <button a href="##publish_modal"  type="button" id="publish" class="btn btn-secondary" data-bs-toggle="modal" data-keyring="#id#" data-keyusername="#htmlEditFormat(user_name)#" data-keyid="#pgp_key_id#"><i class="fas fa-share-alt"></i></button>
          ...
          <cfelse>
            ...
            <td>
              ...
              <button a href="##delete_modal"  type="button" id="delete" class="btn btn-danger" data-bs-toggle="modal" data-keyring="#id#"><i class="fas fa-trash-alt"></i></button>
...
<!--- DELETE KEYRING MODAL SCRIPT ENDS HERE  --->

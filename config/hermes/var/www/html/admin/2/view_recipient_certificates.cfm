...
<cfoutput>
<a href="##create_modal"  class="btn btn-primary" role="button" data-bs-toggle="modal" data-recipient="#theRecipient#"><i class="fa fa-plus-square fa-lg"></i>&nbsp;&nbsp;Create Certificate</a>
</cfoutput>
...
<!--- CREATE CERTIFICATE BUTTON ENDS HERE --->
    ...
    <cfoutput>
    <a href="##import_modal"  class="btn btn-primary" role="button" data-bs-toggle="modal" data-recipient="#theRecipient#"><i class="fa fa-upload fa-lg"></i>&nbsp;&nbsp;Import Certificate</a>
  </cfoutput>
      ...
      <cfoutput query="getcertificates">
          ...
          <tr>
            ...
            <td>
              ...
              <button a href="##send_modal"  type="button" id="send" class="btn btn-secondary" data-bs-toggle="modal" data-certificate="#id#" data-password="#decryptedPassword#"><i class="fas fa-share-alt"></i></button>

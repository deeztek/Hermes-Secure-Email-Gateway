                  ...
                  <tr align="left" valign="top">
                    <td>
                      ...
                      <table border="0" cellspacing="0" cellpadding="0" width="962">
                        ...
                        <tr valign="top" align="left">
                          <td></td>
                          <td width="950" id="Text502" class="TextObject" style="background-color: rgb(102,153,51);">
                            <p style="margin-bottom: 0px;"><b><span style="color: rgb(255,255,255);">This page has been upgraded to our 2.0 interface. Please click <a href="/admin/2/view_network_settings.cfm">here</a> to use the new version</span></b></p>
                          </td>
                        </tr>
                      </table>
                    </td>

                                                    ...
                                                    <td id="Cell530">
                                                      <table width="246" border="0" cellspacing="0" cellpadding="0" align="left">
                                                        <tr>
                                                          <td class="TextObject">
                                                            <p style="margin-bottom: 0px;"><cfif #show_type# is "ip">
<input type="text" name="ip_address" size="30" maxlength="45" style="width: 236px; white-space: pre;" value="#show_ip_address#">
<cfelseif #show_type# is "network">
<input type="text" name="ip_address" size="30" maxlength="45" style="width: 236px; white-space: pre;" value="#show_ip_address#" disabled="disabled">
</cfif>
&nbsp;</p>
                                                          </td>
                                                        </tr>
                                                    ...
                                                    <td id="Cell550">
                                                      <table width="247" border="0" cellspacing="0" cellpadding="0" align="left">
                                                        <tr>
                                                          <td class="TextObject">
                                                            <p style="margin-bottom: 0px;"><cfif #show_type# is "network">
<input type="text" name="network_address" size="30" maxlength="45" style="width: 236px; white-space: pre;" value="#show_network_address#">
<cfelseif #show_type# is "ip">
<input type="text" name="network_address" size="30" maxlength="45" style="width: 236px; white-space: pre;" value="#show_network_address#" disabled="disabled">
</cfif>&nbsp;</p>
                                                          </td>
                                                        </tr>
                                                      </table>

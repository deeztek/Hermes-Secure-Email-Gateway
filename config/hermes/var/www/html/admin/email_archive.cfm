...
<cffile action = "write"
    file = "/var/www/html/schedule/#show_entry_name#_archive_task.cfm"
    output = "#archivetask#"> 
...
<option value="#TimeFormat(i, "HH:mm:ss")#">#TimeFormat(i, "hh:mm tt")#</option>
                                      ...
                                      <table border="0" cellspacing="0" cellpadding="0" width="959">
                                        ...
                                        <tr valign="top" align="left">
                                          <td width="959" id="Text277" class="TextObject"><p style="margin-bottom: 0px;"><cfif #m# is "1">
<cfoutput>
...
<td id="Cell765">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="center"><input type="image" id="FormsButton1" name="FormsButton1" src="delete_icon_off.png" alt="Cannot delete while Archive Job is Currently Running" title="Cannot delete while Archive Job is Currently Running" style="height: 19px; border-start-width: 0px; border-start-style: solid; border-top-width: 0px; border-top-style: solid; border-end-width: 0px; border-end-style: solid; border-bottom-width: 0px; border-bottom-style: solid; width: 19px;"></td>
          </tr>
        </table>
...
<td id="Cell765">
      <form name="Cell765FORM" action="remount_archive_share.cfm" method="post">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="center"><input type="image" id="FormsButton1" name="FormsButton1" src="remount.png" style="height: 19px; border-start-width: 0px; border-start-style: solid; border-top-width: 0px; border-top-style: solid; border-end-width: 0px; border-end-style: solid; border-bottom-width: 0px; border-bottom-style: solid; width: 19px;"></td>
          </tr>
        </table>
      </form>
    </td>
...
<td id="Cell765">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="center"><input type="image" id="FormsButton1" name="FormsButton1" src="remount_off.png" alt="Cannot remount share while Archive Job is Currently Running" title="Cannot remount share while Archive Job is Currently Running" style="height: 19px; border-start-width: 0px; border-start-style: solid; border-top-width: 0px; border-top-style: solid; border-end-width: 0px; border-end-style: solid; border-bottom-width: 0px; border-bottom-style: solid; width: 19px;"></td>
          </tr>
        </table>
...
<td id="Cell765">
      <form name="Cell765FORM" action="run_archive_job.cfm" method="post">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="center"><input type="image" id="FormsButton1" name="FormsButton1" src="run_icon.png" style="height: 19px; border-start-width: 0px; border-start-style: solid; border-top-width: 0px; border-top-style: solid; border-end-width: 0px; border-end-style: solid; border-bottom-width: 0px; border-bottom-style: solid; width: 19px;"></td>
          </tr>
        </table>
      </form>
    </td>
...
<td id="Cell765">
      <form name="Cell765FORM" action="stop_archive_job.cfm" method="post">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="center"><input type="image" id="FormsButton1" name="FormsButton1" src="stop_icon.png" style="height: 19px; border-start-width: 0px; border-start-style: solid; border-top-width: 0px; border-top-style: solid; border-end-width: 0px; border-end-style: solid; border-bottom-width: 0px; border-bottom-style: solid; width: 19px;"></td>
          </tr>
        </table>
      </form>
    </td>

<cfelseif #checkarchive.pid# is "">

<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="center"><input type="image" id="FormsButton1" name="FormsButton1" src="stop_icon_off.png" alt="Cannot stop job job yet. Please try the stop operation again later"  style="height: 19px; border-start-width: 0px; border-start-style: solid; border-top-width: 0px; border-top-style: solid; border-end-width: 0px; border-end-style: solid; border-bottom-width: 0px; border-bottom-style: solid; width: 19px;"></td>
          </tr>
        </table>


<!--- /CFIF FOR #checkarchive.pid# --->
</cfif>

<!--- /CFIF FOR #archivestatus#  --->
</cfif>

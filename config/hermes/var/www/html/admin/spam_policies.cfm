...
<table id="Table97" border="0" cellspacing="4" cellpadding="0" width="100%" style="border-start-color:  rgb(219,217,217); border-start-style: solid;
 border-top-color:  rgb(219,217,217); border-top-style: solid; border-end-color:  rgb(219,217,217); border-end-style: solid; border-bottom-color:
...
<table id="Table100" border="0" cellspacing="4" cellpadding="0" width="100%" style="border-start-color:  rgb(219,217,217); border-start-style: solid;
 border-top-color:  rgb(219,217,217); border-top-style: solid; border-end-color:  rgb(219,217,217); border-end-style: solid; border-bottom-color:
  rgb(219,217,217); border-bottom-style: solid; height: 45px;">
 <tr style="height: 28px;">
...
<table id="Table78" border="0" cellspacing="4" cellpadding="0" width="100%" style="border-start-color:  rgb(255,255,255); border-start-style: solid;
 border-top-color:  rgb(255,255,255); border-top-style: solid; border-end-color:  rgb(255,255,255); border-end-style: solid; border-bottom-color:

...
<cfif #failureallowsender# is not "0">
  ...
  <div class="modal fade" id="messageactions_modal" tabindex="-1" role="dialog" aria-labelledby="MessageActionsModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      ...
      <option value="Release Msg">Release Message(s) to Mailbox</option>

      <cfif #session.train_bayes# is "1">
...
<cfelse>
  ...
  <cfset m="Message History Train Ham: session.train_bayes is not 1">
  <cfinclude template="./inc/error.cfm">
  <cfabort>
...
<cfelse>
  ...
  <cfset m="Message History Train Spam: session.train_bayes is not 1">
  <cfinclude template="./inc/error.cfm">
  <cfabort>
...
<cfelse>
  ...
  <cfset m="Message History Forget Bayes: session.train_bayes is not 1">
  <cfinclude template="./inc/error.cfm">
  <cfabort>
...
<cfoutput query="getmsgs">
       ...
       <td>
        ...
        <a href="view_message.cfm?mid=#mail_id#&startdate=#startdate#&enddate=#enddate#&limit=#limit#" class="btn btn-secondary" role="button"><i class="fas fa-search"></i></a>

...
<cfset isRelayUserPanel = (session.theGroups CONTAINS "relays") AND NOT (session.theGroups CONTAINS "mailboxes")>
...
<div class="row">
  <div class="col-12 col-lg-9 col-xl-7">
    ...
    <div class="card card-warning card-outline">
      ...
      <div class="card-body">
        <cfif isRelayUserPanel>
          <!--- Relay user: simpler bootstrap. Verification email arrives at
               their existing upstream mailbox, no /nc tab dance needed.
               (##225 Phase 2) --->
          <div class="alert alert-warning mb-3">
            <p class="mb-2"><strong>Your administrator requires Two-Factor Authentication (2FA) on your account.</strong></p>
            <p class="mb-0">Until you enable 2FA, your portal access is limited to <strong>Account Settings</strong>. Other sections (Notification Settings, Sender Filters, Message History) unlock automatically once you're enrolled.</p>
          </div>

          <h5 class="mb-2">How to enable 2FA</h5>
          <ol class="mb-3">
            <li class="mb-2">Go to <a href="user_settings.cfm">Account Settings</a> and click <strong>Enable 2FA now</strong>. You'll be signed out and returned to the sign-in page.</li>
            <li class="mb-2">Sign back in. Authelia will walk you through registering a 2FA device.</li>
            <li class="mb-2">A verification email arrives at your existing mailbox &mdash; open it and click the link.</li>
        ...
        <cfelse>
          <!--- Mailbox user: 5-step bootstrap with the Webmail-tab trick to
               work around the chicken-and-egg of needing email access to
               complete Authelia's identity verification. --->
          <div class="alert alert-warning mb-3">
            <p class="mb-2"><strong>Your administrator requires Two-Factor Authentication (2FA) on your account.</strong></p>

...
SELECT recipients.recipient as rcptemail, user_settings.report_enabled, user_settings.report_frequency, user_settings.email from user_settings LEFT JOIN recipients ON recipients.recipient = user_settings.email where user_settings.report_enabled = 'ALL' and user_settings.report_frequency = '24' and recipients.recipient is not NULL
</cfquery>
...
<cfmail from="#getpostmaster.value#" to="#TRIM(rcptemail)#" subject="[#rcptemail#] Hermes SEG Daily Quarantine Report" type="HTML" server="hermes_postfix_dkim" port="10026">
    <HTML>
...
<table id="Table2" border="0" cellspacing="6" cellpadding="2" width="100%" style="height: 50px;">
  <tr style="height: 75px;">
    <td style="background-color: rgb(255,255,255);">
      <p style="text-align: center; margin-bottom: 0px;"><img id="Picture1" src="cid:hermeslogo" style="max-height: 80px; width: auto;" vspace="0" hspace="0" align="top" border="0" alt="hermes_secure_mail_gateway" title="Hermes Secure Email Gateway"></p>
    </td>
  </tr>
...
SELECT recipients.recipient as rcptemail, user_settings.report_enabled, user_settings.report_frequency from user_settings LEFT JOIN recipients ON recipients.recipient = user_settings.email where user_settings.report_enabled = 'YES' and user_settings.report_frequency = '24' and recipients.recipient is not NULL
</cfquery>

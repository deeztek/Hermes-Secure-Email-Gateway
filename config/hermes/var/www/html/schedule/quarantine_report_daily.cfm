...
SELECT users.email as rcptemail, user_settings.report_enabled, user_settings.report_frequency, user_settings.email from user_settings LEFT JOIN users ON users.email = user_settings.email where user_settings.report_enabled = 'ALL' and user_settings.report_frequency = '24' and users.email is not NULL
</cfquery>
...
SELECT users.email as rcptemail, user_settings.report_enabled, user_settings.report_frequency from user_settings LEFT JOIN users ON users.email = user_settings.email where user_settings.report_enabled = 'YES' and user_settings.report_frequency = '24' and users.email is not NULL
</cfquery>

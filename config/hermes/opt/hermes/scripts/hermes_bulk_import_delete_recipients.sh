...
echo "${GREEN}Hermes SEG Recipient Bulk ${THEACTION} completed succesfully. Please navigate to 'Gateway --> Relay Recipients' to 'Apply Settings' and complete the recipient ${THEACTION} into your system.${RESET}"
fi

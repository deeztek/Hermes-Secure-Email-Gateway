...
/usr/bin/openssl aes-256-cbc -pass pass:UIeocFdAeq3k/ewFUS/k2Ol+EEsRlNMHz21WWabsZXE= -a -salt -in $BACKUPS/hermes_sys_enc_$TIMESTAMP.rar -out $BACKUPS/hermes_sys_enc_$TIMESTAMP.backup
...
/bin/rm -rf $BACKUPS/hermes_sys_enc_$TIMESTAMP.rar

...
/sbin/umount -f -l /mnt/hermesrestore
...
#PERFORM THE RESTORE
cd /
/usr/bin/unrar x -y $BACKUPS/$TRANSACTION.rar
cd $BACKUPS
/usr/bin/unrar x -y $BACKUPS/$TRANSACTION.rar  mnt/hermesbackups/dbbkup/*

/usr/bin/mysql -u root -p***REDACTED-CRED*** hermes < $BACKUPS/mnt/hermesbackups/dbbkup/hermes.sql
/usr/bin/mysql -u root -p***REDACTED-CRED*** djigzo < $BACKUPS/mnt/hermesbackups/dbbkup/djigzo.sql
/usr/bin/mysql -u root -p***REDACTED-CRED*** Syslog < $BACKUPS/mnt/hermesbackups/dbbkup/syslog.sql

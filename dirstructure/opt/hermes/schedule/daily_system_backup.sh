...
/bin/mount '//ovhfs.hosting.deeztek.com/shares/backups/relay' -t cifs -o uid=1000,gid=1000,vers=2.0,username='hermesbackup',domain='OVHFS',password='5NKe2J6f!r0aZVuL2etm' /mnt/hermesbackups/ 2>&1 | tee /opt/hermes/tmp/backup_mount.log

...
echo "/usr/bin/curl -X 'POST' -k 'http://127.0.0.1:8888/hermes-api/' -H 'accept: */*' -H 'X-Original-URL: /admin/2/inc/check_system_update.cfm?sendemail=1' -H 'X-Token: $THETOKEN'" > /opt/hermes/tmp/run.sh

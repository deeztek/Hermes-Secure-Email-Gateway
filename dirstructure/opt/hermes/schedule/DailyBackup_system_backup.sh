...
/bin/mount '//192.168.70.100/shares/backups/relay' -t cifs -o uid=1000,gid=1000,vers=2.0,username='hermesbackup',domain='FREENAS-NS570746',password='VfM42YrLwaEaz2rMYEgD' /mnt/hermesbackups/ 2>&1 | tee /opt/hermes/tmp/backup_mount.log

...
<html lang="en">
    <head>
      ...
      <title>Hermes SEG | View Messages</title>
...
<cfset m="Preloader: url.page is empty">
<cfinclude template="./inc/error.cfm">
<cfabort>

<!--- /CFIF for url.page is not "" --->
</cfif>

<cfelse>

<cfset m="Preloader: url.page doesn't exist">
<cfinclude template="./inc/error.cfm">
<cfabort>
...
<!---
 ...
 --->
    ...
    <cfset m="Preloader: url.startdate is invalid">
    <cfinclude template="./inc/error.cfm">
    <cfabort>
    ...
    <!--- /CFIF NOT isValid("date", #url.startdate#) --->
     ...
     <cfset m="Preloader: url.startdate is empty">
     <cfinclude template="./inc/error.cfm">
     <cfabort>
    ...
    <cfelseif url.enddate is "">
      ...
      <cfset m="Preloader: url.enddate is empty">
      <cfinclude template="./inc/error.cfm">
      <cfabort>
    ...
    <cfset m="Preloader: url.limit is empty">
    <cfinclude template="./inc/error.cfm">
    <cfabort>
...
<cfoutput>
<meta http-equiv="refresh" content="3;url=#page#?mid=#url.mid#&startdate=#startdate#&enddate=#enddate#&limit=#limit#">
</cfoutput>

...
<cfif #step# is "7" and #show_mysqlusername# is not "">
<cfset step=8>
<cfelseif #step# is "7" and #show_mysqlusername# is "">
<cfset step=0>
<cfset m=22>
</cfif>


<cfif #step# is "8" and #show_mysqlpassword# is not "">
<cfset step=9>
<cfelseif #step# is "8" and  #show_mysqlpassword# is "">
<cfset step=0>
<cfset m=23>
</cfif>

<cfif #step# is "9" and #show_notification# is not "">
...
<cfelseif #step# is "9" and #show_notification# is "">
<cfset step=0>
<cfset m=11>
</cfif>

<cfif #step# is "10" and #startdate# is not "">
...
<cfelseif #step# is "10" and #startdate# is "">
<cfset step=0>
<cfset m=13>
</cfif>
...
<cffile action = "write"
    file = "/opt/hermes/schedule/#show_entry_name#_system_backup.sh"
    output = "#REReplace("#backup#","SAMBAVER","#smbversion#","ALL")#">  
...
<cffile action = "write"
    file = "/opt/hermes/schedule/#show_entry_name#_system_backup.sh"
    output = "#REReplace("#backup#","MYSQL-USER","#show_mysqlusername#","ALL")#"> 
    
<cffile action="read" file="/opt/hermes/schedule/#show_entry_name#_system_backup.sh" variable="backup">
   
<cffile action = "write"
    file = "/opt/hermes/schedule/#show_entry_name#_system_backup.sh"
    output = "#REReplace("#backup#","MYSQL-PASS","#show_mysqlpassword#","ALL")#"> 
...
<cffile action = "write"
    file = "/opt/hermes/schedule/#show_entry_name#_system_backup.sh"
    output = "#REReplace("#backup#","FROM-EMAIL","#getpostmaster.value#","ALL")#"> 
...
<cffile action = "write"
    file = "/opt/hermes/schedule/#show_entry_name#_system_backup.sh"
    output = "#REReplace("#backup#","TO-EMAIL","#show_notification#","ALL")#"> 
...
<cfset show_username="">
<cfset show_mysqlusername="">
<cfset show_password="">
<cfset show_mysqlpassword="">

                      ...
                      <table border="0" cellspacing="0" cellpadding="0" width="962">
                        ...
                        <tr valign="top" align="left">
                          ...
                          <td colspan="2" width="950" id="Text502" class="TextObject" style="background-color: rgb(102,153,51);">
                            <p style="margin-bottom: 0px;"><b><span style="color: rgb(255,255,255);">System Restore is no longer configured via the Admin Console. Please refer to the System Restore documentation for details.</span></b></p>
                          </td>
                        </tr>
                      </table>
                    </td>

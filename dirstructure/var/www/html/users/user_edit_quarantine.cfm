...
<cfelseif #form.todo# is "displayrows">
...
<cflocation url="loading.cfm?StartRow=#url.StartRow#&DisplayRows=#displayrows#&startdate=#url.startdate#&enddate=#url.enddate#&starttime=#url.starttime#&endtime=#url.endtime#&action=#url.action#" addtoken="no">

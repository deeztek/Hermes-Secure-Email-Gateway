 ...
 <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/users/index.cfm" class="nav-link">Old Web GUI</a>
      </li>
      <!---
      <li class="nav-item d-none d-sm-inline-block">
...
<!---
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" onclick="window.open('https://docs.deeztek.com/books/hermes-seg-user-guide')" role="button" title="Documentation"><i class="fas fa-book fa-lg"></i>
          </a>
      </li>
